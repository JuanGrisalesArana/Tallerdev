...
@section('titulo') AppDev-Asignatura 
@endsection
...
<td>{{ $per->creditos }}</td>
<td>
<a href="{{URL::action('App\Http\Controllers\AsignaturaController@edit',$per->id)}}"><button class="btn btn-primary">Actualizar</button></a>
